...
interface CompetitorChurnTrendData {
  year: number
  faras: number
  uber: number
  little: number
...
interface CompetitorChurnTrendProps {
  data: CompetitorChurnTrendData[]
}

export default function CompetitorChurnTrend({ data = [] }: CompetitorChurnTrendProps) {
  ...
  const filterDataByDateRange = (data: CompetitorChurnTrendData[]) => {
